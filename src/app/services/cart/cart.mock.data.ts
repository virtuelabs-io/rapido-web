...
let cartItemDetails = new CartItemDetails(cartItem, itemDetails)
export class CartMockData {
  public static getCartItems: CartItemDetails[] = [cartItemDetails]

  public static getCartItem: CartItem = cartItem

  public static cartCount: number = 5

  public static getSavedForLater: CartItem[] = [cartItem]

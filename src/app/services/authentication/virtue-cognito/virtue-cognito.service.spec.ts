...
describe('VirtueCognitoService', () => {
  ...
  it('Cognito userPool clientId to match the Constants', () => {
    const service: VirtueCognitoService = TestBed.get(VirtueCognitoService);
    expect(service.cognitoUserPool.getClientId()).toEqual(Constants.POOL_DATA.ClientId)
  })

  it('Cognito userPool UserPoolId to match the Constants', () => {
    const service: VirtueCognitoService = TestBed.get(VirtueCognitoService);
    expect(service.cognitoUserPool.getUserPoolId()).toEqual(Constants.POOL_DATA.UserPoolId)
  })

  it('Cognito userUserPool to match', () => {
    const service: VirtueCognitoService = TestBed.get(VirtueCognitoService);
    expect(service.cognitoUserPool).toEqual(new CognitoUserPool(Constants.POOL_DATA))
  })

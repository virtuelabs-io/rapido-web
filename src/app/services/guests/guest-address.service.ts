...
export class GuestAddressService extends RapidoHttpService<GuestAddressDetails> {
  ...
  postGuestAddressDetails(guestAddressDetails: GuestAddressDetails){
    return this.post([Constants.GUESTS_APIS.api, localStorage.getItem(Constants.RAPIDO_SESSION_ID), 'address'].join("/"), guestAddressDetails)
  }
}

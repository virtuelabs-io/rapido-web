...
describe('ProductsHierarchyService', () => {
  ...
  it('should be created', () => {
    const service: ProductsHierarchyService = TestBed.get(ProductsHierarchyService);
    ...
    fakeAsync(
      inject(
        ...
        (service: ProductsHierarchyService, backend: HttpTestingController) => {
          ...
          const requestWrapper = backend.expectOne({url: Constants.environment.staticAssets + Constants.PRODUCT_HIERARCHY});

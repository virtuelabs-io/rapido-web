      ...
      if(data['orderItemsObject']) {
        for(let order in data['orderItemsObject']) {
          ...
          for(let product in data['orderItemsObject'][order]) {
            ...
            this.orders[order].order_price = data['orderItemsObject'][order][product].order_price.toFixed(2)
            this.orders[order].order_price_total = data['orderItemsObject'][order][product].order_price_total.toFixed(2)
            this.orders[order].delivery_cost = data['orderItemsObject'][order][product].delivery_cost.toFixed(2)
            this.orders[order].vat = data['orderItemsObject'][order][product].vat.toFixed(2)
